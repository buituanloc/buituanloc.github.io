        ...
        margin-top: 5px;
          ...
          <?php 
                     ...
                     if(isset($_POST['submit_them'])){
                        ...
                        $checktk="select * from thanhvienhqshop where tentaikhoan='$ten'";
                        ...
                        //check tồn tại email
                        $checkmail="select * from thanhvienhqshop where email='$email'";
                        ...
                        $sql_them="insert into thanhvienhqshop (tentaikhoan,matkhau,email,sodienthoai) values ('$ten','$mk','$email','$sdt')";
