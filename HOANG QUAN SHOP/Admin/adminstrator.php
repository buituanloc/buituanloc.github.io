...
<table id="wrapper" width="1300px" border="0px" cellpadding="0px" cellspacing="0px">
	<!-- Header -->
	   <header id="header">
           <div class='left'>
                <div class='logo'>
                    <a href="adminstrator.php" title=""><img src="images/logo2xam.png" alt=""></a>
                </div>
           </div>
           <div class='right'>
               <div class='quantri'>
                       TRANG QUẢN TRỊ WEBSITE HQSHOP
               </div>
               <div class='menu'>
                   <ul>
    ...
    <tr id="body">
    	<td align="left" valign="top" width="250px">
            ...
            <table width="300px" class="left-menu" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr class="menu-item" height="30px">
                    <td><a href="adminstrator.php?page=quanlithanhvien" style='color:#FF6E00;font-size: 13px;font-weight:bold;'>- Quản lý Thành Viên HQSHOP</a></td>
                </tr>
        ...
        error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));  
                    ...
                    if($page=='sp_hauwei' || $page=='sp_hauwei'){
                        include ('sanpham/sp_hauwei.php');
                    }
                    if($page=='sp_oppo' || $page=='sp_Oppo'){
                        include ('sanpham/sp_oppo.php');
                    }
                    if($page=='sp_lenovo' || $page=='sp_lenovo'){
                        include ('sanpham/sp_lenovo.php');
                    }
                    ...
                    if($page=='xoa_oppo'){
                     ...
                     if($page=='sua_hauwei'){
                        include ('sanpham/sua_hauwei.php');
                    }
                    if($page=='xoa_hauwei'){
                        include ('sanpham/xoa_hauwei.php');
                    }
                     if($page=='sua_apple'){
                    ...
                    if($page=='xoa_apple'){
                     ...
                     if($page=='sua_lenovo'){
                        include ('sanpham/sua_lenovo.php');
                    }
                    if($page=='xoa_lenovo'){
                        include ('sanpham/xoa_lenovo.php');
                    }
                    if($page=='them_apple'){
                    ...
                    if($page=='them_lenovo'){
                        include ('sanpham/them_lenovo.php');
                    }
                    if($page=='sp_maytinh'){
...
<div height="62px">
        <p id="footer" colspan="2" align="center" >HQSHOP-Niềm Tin Cậy Của Người Dùng</p>
    </div>
