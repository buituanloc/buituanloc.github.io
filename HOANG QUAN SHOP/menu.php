...
<body>
 <?php 
					...
					if(isset($_REQUEST['submitlogin'])){
						...
						$sql_login="select * from thanhvienhqshop where tentaikhoan='$users' and matkhau='$passs'";
	...
	<div class="main" style='background: url(img/bg-bluesky.jpg);'>
		...
		<div class="cskh-destop">
			<div class="container">
				...
				<div class="cs2 xxx">
					<ul class='cb2'>
						<li><span class='glyphicon glyphicon-earphone'> Hotline:</span> 0989455259</li>
						<?php
				...
				?>	
					...
					<?php
					  include ('MYSQL/connectmysql.php');
					  $fg=$_SESSION['users'];
					$sql="select * from thanhvienhqshop where tentaikhoan='$fg'";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	<div class='ghvl' style='max-width: 140px;'>
        		...
        		<p class='spl'>HQSHOP có rất nhiều sản phẩm mà bạn cần tìm, bạn có thể chọn 
...
?>
		...
		<div class="cskh-phone">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<ul>
							<li class='hotline'><span class='glyphicon glyphicon-earphone'> <strong> HOTLINE/CSKH: </strong></span><b> 0989455259</b></li>
		...
		<!--End Phone-->
			...
			<div class="container">
				...
				<div class="left">
					<div class="logo">
					<a href="index.php"><img src="img/logoxam51.png" alt="logo"></a>
					</div>
				</div>
				<div class="right">
					<ul>
			...
			<div class="nav-smart">
				<div class="container">
				<div class="logo">
					<a href="index.php"><img src="img/logo2xamdam.jpg" alt=""></a>
				</div>
				<div class="nut-menu">
